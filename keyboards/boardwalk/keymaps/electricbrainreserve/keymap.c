 ...
 * ├──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┤
 * │ Tab  │   A  │   S  │   D  │   F  │   G  │FLASH │ Home │   H  │   J  │   K  │   L  │   ;  │   '  │
 * ├──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┤
 * │ Shft │   Z  │   X  │   C  │   V  │   B  │FUNC  │ End  │   N  │   M  │   ,  │   .  │   /  │ Shft │
 * ├──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┤
 ...
 */
 ...
 [_QWERTY] = LAYOUT_ortho_hhkb(
        ...
        KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,     KC_G, TTFLASH, KC_HOME, KC_H, KC_J,    KC_K,    KC_L,   KC_SCLN, KC_QUOT,
		KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,     KC_B, TTFUNC,  KC_END,  KC_N, KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
...
<<<<<<< HEAD
		...
		KC_NO, KC_NO,   RGB_SAI, RGB_SAD,  RGB_SPI, RGB_SPD, KC_TRNS,   KC_NO,  KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,  KC_NO,
		KC_NO, KC_NO,   RGB_HUI, RGB_HUD,  RGB_VAI, RGB_VAD, KC_TRNS, KC_NO,  KC_NO, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, KC_NO,
			     RGB_TOG, RGB_MOD, RGB_RMOD, KC_NO,   	  KC_NO,   		       KC_NO, 	 KC_NO, 	KC_PGDN, KC_PGUP, KC_NO),
=======
...
>>>>>>> 85f8c5898b46e7eb19c228253eb87fd6543254ea
};
