...
#define FUNCL TT(_FUNC)
#define RESET TT(_RESET)
 ...
 */
 ...
 [_QWERTY] = LAYOUT_ortho_hhkb(
    	...
    	KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,     KC_G, RESET, 	  KC_HOME, KC_H, KC_J,    KC_K,    KC_L,   KC_SCLN, KC_QUOT,
		KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,     KC_B, FUNCL, 	  KC_END,  KC_N, KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
