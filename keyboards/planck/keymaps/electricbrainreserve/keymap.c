...
enum ebr_tap_dance_keycodes { SPC_ENT };

#define LOWER MO(_LOWER)
#define RAISE MO(_RAISE)
#define SPCENT TD(SPC_ENT)

qk_tap_dance_action_t tap_dance_actions[] = {[SPC_ENT] = ACTION_TAP_DANCE_DOUBLE(KC_SPC, KC_ENT)};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    * ├──────┼──────┼──────┼──────┼──────┼──────┴──────┼──────┼──────┼──────┼──────┼──────┤
    * │PrtScn│ Ctrl │ Alt  │ Gui  │Lower │   SPC/ENT   │Raise │ Left │ Down │  Up  │ Right│
    * └──────┴──────┴──────┴──────┴──────┴─────────────┴──────┴──────┴──────┴──────┴──────┘
    */
    // clang-format off
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_PSCR, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   SPCENT,  SPCENT,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
